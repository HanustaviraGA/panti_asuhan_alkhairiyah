            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="/Anak Asuh/">Anak Asuh</a></li>
      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="image.png" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
          ...
          <div class="carousel-item">
            <img src="image 2.png" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
            <div class="carousel-caption d-md-block">
              <h5>Ini contoh</h5>
              <p>contoh</p>
            </div>
          ...
          <div class="carousel-item">
            <img src="image 1.png" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
            <div class="carousel-caption d-md-block">
              <h5>Ini contoh</h5>
              <p>contoh</p>
            </div>
