                ...
                @for($i = 0; $i < $jml; $i++)
                    @if($i == 0)
                        <div class="carousel-item active">
                            <img src="{{ asset('uploads/program/mingguan/'.$mingguan[$i]->img.'') }}" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
        ...
        <div id="carouselExampleCaptions2" class="carousel slide" data-bs-ride="false">
            ...
            <div class="carousel-inner">
                @for($i = 0; $i < $jml; $i++)
                    @if($i == 0)
                        <div class="carousel-item active">
                            <img src="{{ asset('uploads/program/bulanan/'.$bulanan[$i]->img.'') }}" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
                            <div class="carousel-caption d-md-block">
        ...
        <div id="carouselExampleCaptions3" class="carousel slide" data-bs-ride="false">
            ...
            <div class="carousel-inner">
                @for($i = 0; $i < $jml; $i++)
                    @if($i == 0)
                        <div class="carousel-item active">
                            <img src="{{ asset('uploads/program/tahunan/'.$tahunan[$i]->img.'') }}" class="d-block w-100" alt="panti asuhan" style="height: 500px;">
                            <div class="carousel-caption d-md-block">
